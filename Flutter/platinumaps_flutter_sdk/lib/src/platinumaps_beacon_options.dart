...
///
/// Values are passed through to the embedded web app and govern how
/// the map reacts to incoming beacon data. Once a [PlatinumapsMapView]
/// has been constructed, the beacon options are immutable for the
/// lifetime of that view — rebuild the widget with a new instance to
/// change them.
class PlatinumapsBeaconOptions {
  ...
  /// Wire form sent across the platform channel. Not part of the
  /// stable public API surface; subject to change without notice.
